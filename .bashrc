...
alias lhdev='curl localhost:3000 && echo ""'
alias lhdev8='curl localhost:8000 && echo ""'
alias start='~/dotfiles/dotfiles/newNodeProject.sh'
alias bashedit='vim ~/.bashrc'
alias nodestop='ps -a | grep node'
alias rebash='source ~/.bashrc'
alias electronstart='~/dotfiles/dotfiles/electronstart.sh'
